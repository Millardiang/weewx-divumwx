...
try:
    ...
    def logmsg(level, msg):
        syslog.syslog(level, 'dvmhighchartsSearchX: %s' % msg)
...
class dvmhighcharts_temp_week(SearchList):
    """SearchList to generate JSON vectors for dvmhighcharts week plots."""
    ...
    def get_extension_list(self, timespan, db_lookup):
        ...
        # Get our time vector in ms (dvmhighcharts requirement)
        ...
        t2 = time.time()
        logdbg2("dvmhighcharts_temp_week SLE executed in %0.3f seconds" % (t2 - t1))

        # Return our json data
        return [self.search_list_extension]

class dvmhighcharts_bar_rain_week(SearchList):
    """SearchList to generate JSON vectors for dvmhighcharts week plots."""
    ...
    def get_extension_list(self, timespan, db_lookup):
        ...
        t2 = time.time()
        logdbg2("dvmhighcharts_bar_rain_week SLE executed in %0.3f seconds" % (t2 - t1))

        # Return our json data
        return [self.search_list_extension]
  
class dvmhighcharts_wind_week(SearchList):
    """SearchList to generate JSON vectors for dvmhighcharts week plots."""
    ...
    def get_extension_list(self, timespan, db_lookup):
        ...
        t2 = time.time()
        logdbg2("dvmhighcharts_wind_week SLE executed in %0.3f seconds" % (t2 - t1))

        # Return our json data
        return [self.search_list_extension]
        
class dvmhighcharts_solar_week(SearchList):
    """SearchList to generate JSON vectors for dvmhighcharts week plots."""
    ...
    def __init__(self, generator):
        ...
        if self.insolation_binding is None:
            # Try [StdReport][[dvmhighcharts]]
            try:
                self.insolation_binding = generator.config_dict['StdReport']['dvmhighcharts'].get('insolation_binding')
                ...
                # [[dvmhighcharts]] in [StdReport]
                self.insolation_binding = None
        try:
            self.db_field = generator.config_dict['DivumCloudCover'].get('db_field')
        except:
            self.db_field = None
    ...
    def get_extension_list(self, timespan, db_lookup):
        ...
        t2 = time.time()
        logdbg2("dvmhighcharts_solar_week SLE executed in %0.3f seconds" % (t2 - t1))

        # Return our json data
        return [self.search_list_extension]
     
class dvmhighcharts_indoor_derived_week(SearchList):
    """SearchList to generate JSON vectors for dvmhighcharts week plots."""
    ...
    def get_extension_list(self, timespan, db_lookup):
        ...
        t2 = time.time()
        logdbg2("dvmhighcharts_indoor_derived_week SLE executed in %0.3f seconds" % (t2 - t1))

        # Return our json data
        return [self.search_list_extension]
     
class dvmhighchartsYear(SearchList):
    """SearchList to generate JSON vectors for dvmhighcharts week plots.""""""SearchList to generate JSON vectors for dvmhighcharts year plots."""
    ...
    def get_extension_list(self, timespan, db_lookup):
        ...
        t2 = time.time()
        logdbg2("dvmhighchartsYear SLE executed in %0.3f seconds" % (t2 - t1))

        # Return our json data
        return [self.search_list_extension]

class dvmhighcharts_wind_rose_week(SearchList):
    """SearchList to generate JSON vectors for dvmhighcharts windrose plots."""
    ...
    def calcWindRose(self, timespan, db_lookup, period, source, dir):
        ...
        # -ve number. We supply dvmhighcharts with the -ve value in y axis units
        # and dvmhighcharts and some javascript takes care of the rest. # First we
    ...
    def get_extension_list(self, timespan, db_lookup):
        ...
        t2 = time.time()
        logdbg2("dvmhighchartsWindRose SLE executed in %0.3f seconds" % (t2 - t1))
