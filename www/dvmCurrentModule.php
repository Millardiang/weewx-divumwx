...
//rain-weather34
if($rain["rate"]>0 && $wind["speed_avg"]>15){echo "<img rel='prefetch' src='img/meteocons/umbrella-wind.svg' width='60px' height='55px' alt='weather34 windy rain icon'>";}
else if($rain["rate"]>10){echo "<img rel='prefetch' src='img/meteocons/umbrella-wind-alt.svg' width='70px' height='60px' alt='weather34 heavy rain icon'>";}
else if($rain["rate"]>0){echo "<img rel='prefetch' src='img/meteocons/rain.svg' width='70px' height='60px' alt='weather34 rain icon'>";}
//fog-weather34
else if($temp["outside_now"] -$dew["now"] <0.8  && $dayPartNatural == "night" && $temp["outside_now"]>5){echo "<img rel='prefetch' src='img/meteocons/fog-night.svg' width='70px' height='60px' alt='weather34 fog icon'>";}
else if($temp["outside_now"] -$dew["now"] <0.8  && $temp["outside_now"]>5){echo "<img rel='prefetch' src='img/meteocons/fog-day.svg' width='70px' height='60px' alt='weather34 fog'>";}
//windy moderate-weather34
else if($wind["speed_avg"]>=15 && $dayPartNatural == "night" && $sky["cloud_cover"]<20){echo "<img rel='prefetch' src='img/meteocons/wind.svg' width='70px' height='60px' alt='weather34 windy icon'>";}
else if($wind["speed_avg"]>=15 && $sky["cloud_cover"]<20){echo "<img rel='prefetch' src='img/meteocons/wind.svg' width='70px' height='60px' alt='weather34 windy icon'>";}
//windy moderate-weather34
else if($wind["speed_avg"]>=15 && $dayPartNatural == "night"){echo "<img rel='prefetch' src='img/meteocons/wind.svg' width='70px' height='60px' alt='weather34 windy icon'>";}
else if($wind["speed_avg"]>=15){echo "<img rel='prefetch' src='img/meteocons/wind.svg' width='70px' height='60px' alt='weather34 windy icon'>";}

//cloud-icon
else if ($sky["cloud_cover"]<7 and $sky["cloud_cover"]>0) {
if ($dayPartNatural == "night" ){echo "<img rel='prefetch' src='img/meteocons/clear-night.svg' width='70px' height='60px' alt='weather34 windy icon'>";} 
else echo "<img rel='prefetch' src='img/meteocons/clear-day.svg' width='70px' height='60px' alt='weather34 windy icon'>"; 
} 
else if ($sky["cloud_cover"]<32) {
if ($dayPartNatural == "night" ){echo "<img rel='prefetch' src='img/meteocons/mostly-clear-night.svg' width='70px' height='60px' alt='weather34 windy icon'>";} 
else echo "<img rel='prefetch' src='img/meteocons/mostly-clear-day.svg' width='70px' height='60px' alt='weather34 windy icon'>"; 
}
else if ($sky["cloud_cover"]<70) {
if ($dayPartNatural == "night" ){echo "<img rel='prefetch' src='img/meteocons/partly-cloudy-night.svg' width='70px' height='60px' alt='weather34 windy icon'>";} 
else echo "<img rel='prefetch' src='img/meteocons/partly-cloudy-day.svg' width='70px' height='60px' alt='weather34 windy icon'>"; 
}
else if ($sky["cloud_cover"]<95) {
if ($dayPartNatural == "night" ){echo "<img rel='prefetch' src='img/meteocons/overcast-day.svg' width='70px' height='60px' alt='weather34 windy icon'>";} 
else echo "<img rel='prefetch' src='img/meteocons/overcast-night.svg' width='70px' height='60px' alt='weather34 windy icon'>"; 
}
else if($sky["cloud_cover"]>=95) {
if ($dayPartNatural == "night" ){echo "<img rel='prefetch' src='img/meteocons/overcast.svg' width='70px' height='60px' alt='weather34 windy icon'>";} 
else echo "<img rel='prefetch' src='img/meteocons/overcast.svg' width='70px' height='60px' alt='weather34 windy icon'>"; 
}
...
if ($windunit=='kts'){$windunit="kn";}
if($wind["gust_60min"]>=50){echo "<ored>" ,number_format(round($wind["gust_60min"],1))."</ored> ".$windunit;}
else if($wind["gust_60min"]>=30){echo "<oorange>" ,number_format(round($wind["gust_60min"],1))."</oorange><valuetext> ".$windunit;}
else if($wind["gust_60min"]>=0){echo "<ogreen>" ,number_format(round($wind["gust_60min"],1))."</ogreen><valuetext> ".$windunit;}echo " </valuetext>last 60 minutes ";
echo  " <br>Average <oblue>Wind Speed</oblue> last 10 minutes ";if($wind["speed_avg"]>=30){echo "<ored>" ,number_format(round($wind["speed_avg"]))."</ored> ".$windunit;}else if($wind["speed_avg"]>=20){echo "<oorange>" .$wind["speed_avg"]."</oorange><valuetext> ".$windunit;}
else if($wind["speed_avg"]>=0){echo "<ogreen>" ,number_format(round($wind["speed_avg"]))."</ogreen><valuetext> ".$windunit;}
echo "</valuetext>";
if($wind["direction_avg"]>0){echo "<br>Average Direction <oorange>"; if($wind["direction_avg"]<=11.25){echo "North";}else if($wind["direction_avg"]<=33.75){echo "NNE";}else if($wind["direction_avg"]<=56.25){echo "NE";}else if($wind["direction_avg"]<=78.75){echo "ENE";}else if($wind["direction_avg"]<=101.25){echo "East";}else if($wind["direction_avg"]<=123.75){echo "ESE";}else if($wind["direction_avg"]<=146.25){echo "SE";}
else if($wind["direction_avg"]<=168.75){echo "SSE";}else if($wind["direction_avg"]<=191.25){echo "South";}else if($wind["direction_avg"]<=213.75){echo "SSW";}else if($wind["direction_avg"]<=236.25){echo "SW";}else if($wind["direction_avg"]<=258.75){echo "WSW";}else if($wind["direction_avg"]<=281.25){echo "West";}else if($wind["direction_avg"]<=303.75){echo "WNW";}else if($wind["direction_avg"]<=326.25){echo "NW";}else if($wind["direction_avg"]<=348.75){echo "NNW";}else{echo "North";}
echo " </oorange><oblue> ".$wind["direction_avg"]."</oblue>°";}
echo "</oorange><br><oblue>Rainfall</oblue> for the last 3 hours <oblue> " .$rain["last_3hour"]."</oblue><valuetext> " .$rainunit;
