...
<button class="tablink" onclick="openPage('Tab4', this, 'rgba(194, 102, 58)')">Sun Duration</button>
...
<div id="Tab2" class="tabcontent">
  ...
  <iframe width="100%" height="92%" scrolling="no" src="dvmSunlightDurationPopup.php" frameborder="0"></iframe>
