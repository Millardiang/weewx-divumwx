...
<div class="higust">Maximum Recorded <br><blue><?php echo $uv["alltime_maxtime"];?></blue></div>
 ...
 <main class="grid1">
  ...
  <iframe  src="w34highcharts/<?php echo $theme1;?>-charts.html?chart='uvsmallplot'&span='yearly'&temp='<?php echo $temp['units'];?>'&pressure='<?php echo $barom['units'];?>'&wind='<?php echo $wind['units'];?>'&rain='<?php echo $rain['units']?>" frameborder="0" scrolling="no" width="100%" height="100%"></iframe>
