      ...
      <div class="weather34toolbar__right">
        <weather34mbuptime>
          <?php echo "Server " . (shell_exec('uptime -p')); ?>
            ...
            <a href="dvmDashboardIndex.php" title="select dashboard mode"><topbarimperial>ER</topbarimperial></a>
...
{ ?>
        <li><!--webcam-->
          <a href="pop_cam.php" data-lity title="WEATHERSTATION WEBCAM"><weather34menumarkeryellow></weather34menumarkeryellow> Web Cam</a>
        </li>
      <?php
} ?>
      <li><!--contact info-->
