...
<main class="grid">
  <article>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////temp max today
	if ($temp["outside_day_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$temp["outside_day_max"] . "</value>";}
...
<div class="temperaturecontainer2">
 <?php
	//temp min today
	if ($temp["outside_day_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$temp["outside_day_min"] . "</value>";}
...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Temp Min</b></span><br><?php echo $temp["outside_day_mintime"];?></span></div>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////dew max today
	if ($tempunit=='C' && $dew["day_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$dew["day_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//dew min today
	if ($dew["day_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$dew["day_min"] . "</value>";}
...
<div class="temperaturecontainer1">
	...
	////humidity max today
	if ($humid["day_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$humid["day_max"] . "</value>";}
...
<div class="temperaturecontainer2">
 <?php
	//humidity min today
	if ($humid["day_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$humid["day_min"] . "</value>";}
...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Hum Min</b></span><br><?php echo $humid["day_mintime"];?></span></div>
 ...
 <article>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////temp max yesterday
	if ($tempunit=='C' && $temp["outside_yesterday_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$temp["outside_yesterday_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//temp min yesterday
	if ($temp["outside_yesterday_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$temp["outside_yesterday_min"] . "</value>";}
...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Temp Min</b></span><br><?php echo $temp["outside_yesterday_mintime"];?></span></div>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////dew max yesterday
	if ($tempunit=='C' && $dew["yesterday_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$dew["yesterday_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//dew min yesterday
	if ($dew["yesterday_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$dew["yesterday_min"] . "</value>";}
...
<div class="temperaturecontainer1">
	...
	if ($humid["yesterday_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$humid["yesterday_max"] . "</value>";}
	echo "<smalluvunit>%</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	...
	if ($humid["yesterday_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$humid["yesterday_min"] . "</value>";}
...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Hum Min</b></span><br><?php echo $humid["yesterday_mintime"];?></span></div>
  ...
  <div class=actualt>&nbsp;<?php echo date('F Y')?> </div>
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////temp max month
	if ($tempunit=='C' && $temp["outside_month_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$temp["outside_month_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//temp min month
	if ($temp["outside_month_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$temp["outside_month_min"] . "</value>";}
...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Temp Min</b></span><br><?php echo $temp["outside_month_mintime"];?></span></div>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////dew max month
	if ($tempunit=='C' && $dew["month_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$dew["month_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//dew min month
	if ($dew["month_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$dew["month_min"] . "</value>";}
...
<div class="temperaturecontainer1">
			  ...
			  <?php
	////humidity max month
	if ($humid["month_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$humid["month_max"] . "</value>";}
	echo "<smalluvunit>%</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//humidity min month
	if ($humid["month_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$humid["month_min"] . "</value>";}
...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Hum Min</b></span><br><?php echo $humid["month_mintime"];?></span></div>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////temp max year
	if ($tempunit=='C' && $temp["outside_year_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$temp["outside_year_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//temp min year
	if ($temp["outside_year_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$temp["outside_year_min"] . "</value>";}
...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Temp Min</b></span><br><?php echo $temp["outside_year_mintime"];?></span></div>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////dew max year
	if ($tempunit=='C' && $dew["year_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$dew["year_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//dew min year
	if ($dew["year_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$dew["year_min"] . "</value>";}
...
<div class="temperaturecontainer1">
			  ...
			  <?php
	////humidity max year
	if ($humid["year_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$humid["year_max"] . "</value>";}
	echo "<smalluvunit>%</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//humidity min year
	if ($humid["year_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$humid["year_min"] . "</value>";}
...
<article>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////temp max all
	if ($tempunit=='C' && $temp["outside_alltime_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$temp["outside_alltime_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//temp min all
	if ($temp["outside_alltime_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$temp["outside_alltime_min"] . "</value>";}
...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Temp Min</b></span><br><?php echo $temp["outside_alltime_mintime"];?></span></div>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////dew max all
	if ($tempunit=='C' && $dew["alltime_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$dew["alltime_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//dew min all
	if ($dew["alltime_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$dew["alltime_min"] . "</value>";}
...
<div class="temperaturecontainer1">
			  ...
			  <?php
	////humidity max all
	if ($humid["alltime_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$humid["alltime_max"] . "</value>";}
	echo "<smalluvunit>%</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//humidity min all
	if ($humid["alltime_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$humid["alltime_min"] . "</value>";}
...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Hum Min</b></span><br><?php echo $humid["alltime_mintime"];?></span></div>
  ...
  <main class="grid1">
  <articlegraph> 
     <iframe  src="w34highcharts/<?php echo $theme1?>-charts.html?chart='tempsmallplot'&span='yearly'&temp='<?php echo $temp['units'];?>'&pressure='<?php echo $barom['units'];?>'&wind='<?php echo $wind['units'];?>'&rain='<?php echo $rain['rain_units']?>" frameborder="0" scrolling="no" width="99.5%" height="100%"></iframe>   
  </articlegraph> 
