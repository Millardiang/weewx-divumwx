...
$fp = FOPEN("../userSettings.php", "w") or die("Unable to open userSettings.php file check file permissions !");
FWRITE($fp, $string);
FCLOSE($fp);
...
?> <?php echo $error; ?> 
  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="pwd" > 
   Enter Your Password For DivumWX-Lite Location Settings Below<br>If it is your first time login, leave blank
<center> <div class="modal-buttons">   
     ...
     <input name="passwd" type="password" class="input-button"/>  <input type="submit" name="submit_pwd" value="Login " class="modal-button" /> 
      ...
      <?php echo "2025-" ;?><?php echo date('Y');?> &copy;</a> DivumWX</span></span></span>
      <br><br>
...
$otherRowOptions = [
	...
	'dvmEtModule.php' => 'Evapotranspiration',
							...
							<div class="row">
								<div class="col-xl-10">
									...
									<div id="links" class="mb-5">
										<h4><i class="fas fa-lock fa-fw text-theme"></i> Password</h4>
										<p>IMPORTANT for your own security and protection you must create a Login Password</p>
										<div class="card">
											<div class="list-group list-group-flush">
												<div class="list-group-item d-flex align-items-center">

													<div class="col-4">
														<div>Unique Login Password</div>
													</div>
													<div class="input-group justify-content-end">
														<input type="text" id="newWUid" name="newWUid" class="newElement form-control someInput"  value="<?php echo $password; ?>">
													</div>
												</div>

 									<div id="modules" class="mb-5"><br><br>
