<?php  include('shared.php');include('common.php');include('dvmCombinedData.php');
error_reporting(0);
...
if ($aqiweather["pm25"] >300){echo "<topdaqi9>",$aqiweather["pm25"]."<smallwindunit>".$aqiweather["pm_units"] ; $aqiweather["band"]= "Hazardous"; } 
 ...
 else if ($aqiweather["pm25"] >100){echo "<topdaqi6>",$aqiweather["pm25"]."<smallwindunit>".$aqiweather["pm_units"] ; $aqiweather["band"]= "Unhealthy"; }
...
<?php //PM10
 ...
 else if ($aqiweather["pm10"] >100){echo "<topdaqi6>",$aqiweather["pm10"]."<smallwindunit>".$aqiweather["pm_units"] ; $aqiweather["band"]= "Unhealthy"; }
