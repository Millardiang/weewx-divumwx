...
<?php 
if ($position4 == 'top_advisory_eu.php')
{
...
<?php 
if ($position4 == 'top_advisory_au.php')
{
...
<?php 
if ($position12 == 'webcamsmall.php' && $dayPartCivil == 'night') { $position12 = 'moonphase.php'; $position12title = 'Moonphase';}
...
{
  echo '<span class="yearpopup"><a alt="solar" title="UV Guide" href="pop_menu_solar.php" data-lity>' . $menucharticonpage . " UV and Solar Almanacs and Guide  </a></span>";
}
...
{
  echo '<span class="yearpopup"><a alt="Lightning Strike Almanac" title="Almanac Lightning"href="pop_lightningalmanac.php". data-lity>' . $chartinfo . " Strike Almanac </a></span>";
}
...
<span class='moduletitle'><a alt="Position12 Switcher" title="Position12 Switcher" href="updatesection.php?pos=position12"></a><?php echo $position12title;?></span></span><div id="position12"></div></div>
