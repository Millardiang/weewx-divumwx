...
<div class= "updatedtime1"<span><?php if(file_exists('jsondata/eq.txt')&&time()- filemtime('jsondata/eq.txt')>300)echo $offline. '<offline> Offline </offline>';else echo $online," ",date($timeFormat, filemtime('jsondata/eq.txt'));?></span></div>
