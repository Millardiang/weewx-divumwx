<?php include('fixedSettings.php');include('shared.php');date_default_timezone_set($TZ);header('Content-type: text/html; charset=utf-8');error_reporting(0);
...
<div style="position:relative; top: -650px; left: 250px;">
<?php
...
echo "<font color='#FF6347'>"."Solar Time: ".$stime." LST</br>";
echo "<font color='white'>"."Lunar Time: ".$mtime." LMST</br>";
