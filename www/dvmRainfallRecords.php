...
<!-- divumwx rain beaker css -- > .rainfallcontainer1 {
  left: 5px;
  top: 0;
}
.rainfalltoday1 {
  ...
  font-size: 0.9rem;
  padding-top: 5px;
  color: #fff; /*! border-bottom: 12px solid #555; */
  align-items: center;
  justify-content: center;
  text-align: center;
  border-radius: 3px;
...
if($primaryRainGuage == "Piezo")
{$rain["dayRain"]=$p_rain["dayRain"];
$rain["last_hour"]=$p_rain["last_hour"];
$rain["yesterday"]=$p_rain["yesterday"];
$rain["month_total"]=$p_rain["month_total"];
$rain["year_total"]=$p_rain["year_total"];
$rain["alltime_total"]=$p_rain["alltime_total"];}
if ($theme === "dark") {
...
<main class="grid">
    ...
    <?php // rain today
echo "<div class='rainfalltoday1' style='background:$colorRainDaySum;'>",$rain["dayRain"] . "</value>";echo "<smalluvunit>".$rain["units"]."</smalluvunit>";?>
</div>
