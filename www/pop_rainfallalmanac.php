...
<div class="hitempy"><?php echo $raininfo . "Last Hour<br><blue> ", $rain["last_hour"]."</blue> " .$rain["units"];?></div>
 ...
 <article>
    ...
    <?php // rain yesterday
echo "<div class='rainfalltoday1'>",$rain["yesterday_total"] . "</value>";echo "<smalluvunit>".$rain["units"]."</smalluvunit>";?>
<div class='w34convertrain'>
<?php //convert rain
if($rain["units"] =='mm'){ echo number_format($rain["yesterday_total"]*0.0393701,2)."<smalluvunit>in</smalluvunit>";}
elseif($rain["units"] =='in'){ echo number_format($rain["yesterday_total"]*25.400013716,2)."<smalluvunit>mm</smalluvunit>";}
?>
<div></div>
...
<div class="hitempy"><?php echo $raininfo;?><!--<blue>Rainfall</blue>-->Since<br/>
 ...
 <main class="grid1">
  ...
  <iframe  src="w34highcharts/<?php echo $theme1;?>-charts.html?chart='rainsmallplot'&span='yearly'&temp='<?php echo $temp['units'];?>'&pressure='<?php echo $barom['units'];?>'&wind='<?php echo $wind['units'];?>'&rain='<?php echo $rain['units'];?>" frameborder="0" scrolling="no" width="100%"  height="100%"></iframe>
