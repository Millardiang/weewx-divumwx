...
$scriptcredits = "CSS/SVG/PHP scripts by <a href='https://divumwx.com' title='divumwx.com' target='_blank'>divumwx.com &copy;2015-".date('Y').""; // for modules
...
$copyYear = 2015;$curYear = date('Y');$divumwxcopyrightcredit='&copy; divumwx.com original CSS/SVG/PHP '.$copyYear . (($copyYear != $curYear) ? '-' . $curYear : 'Copyright');
