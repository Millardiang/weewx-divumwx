...
if (isset($weewxapi))
{
    ...
    $weather["lightning_distance"] = ($weewxrt[58] == "   N/A" ? "0" : $weewxrt[58]);
    $weather["lightning_energy"] = ($weewxrt[59] == "   N/A" ? "0" : $weewxrt[59]);
    $weather["lightning_strike_count"] = ($weewxrt[60] == "   N/A" ? "0" : $weewxrt[60]);
    $weather["lightning_noise_count"] = ($weewxrt[61] == "   N/A" ? "0" : $weewxrt[61]);
    $weather["lightning_disturber_count"] = ($weewxrt[62] == "   N/A" ? "0" : $weewxrt[62]);
    ...
    $weather["alltimeyear"] = ($weewxapi[78] == "   N/A" ? "0" : $weewxapi[78]);
