...
<style>
.rainpossT{margin-top:-5px;margin-left:-160px;}
.stormRainT{margin-top:-147.5px;margin-left:130px;}
</style>
...
<?php 
if($theme == 'dark') {
if ($rain["units"] =='in'){echo "<div class=rainconvertercircle style='color:$colorRainDaySum;'>".number_format($rain["tipping_day"]*25.400013716,1)." <smallrainunit>mm";} else if ($rain["units"] =='mm'){echo "<div class=rainconvertercircle style='color:$colorRainDaySum;'>".number_format($rain["tipping_day"]*0.0393701,2)." <smallrainunit>in";}
} else {
if ($rain["units"] =='in'){echo "<div class=rainconvertercircle style='background:$colorRainDaySum;'>".number_format($rain["tipping_day"]*25.400013716,1)." <smallrainunit>mm";} else if ($rain["units"] =='mm'){echo "<div class=rainconvertercircle style='background:$colorRainDaySum;'>".number_format($rain["tipping_day"]*0.0393701,2)." <smallrainunit>in";}
}
?></span>
</div></div>
...
<div id="raingaugexT"></div>
    ...
    var currentRain = "<?php echo $rain["tipping_day"];?>";
...
if (units == 'in') {
var stormRain = <?php echo $rain["tipping_storm_rain"]/25.4;?>;    
} else {
    stormRain = <?php echo $rain["tipping_storm_rain"];?>;
}
...
var stormStart = "<?php echo $rain["tipping_storm_start"];?>"; 
var rainRate = <?php echo $rain["tipping_rate"];?>;
var lastHour = <?php echo $rain["tipping_last_hour"];?>;
var last24Hours = <?php echo $rain["tipping_24h_total"];?>;
var rainMonth = <?php echo $rain["tipping_month_total"];?>; 
var rainYear = <?php echo $rain["tipping_year_total"];?>;
...
var raining = <?php echo $rain["tipping_rate"];?>;
