...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Hum Min</b></span><br><?php echo $humid["day_mintime"];?></span></div>
 ...
 <article>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////temp max yesterday
	if ($tempunit=='C' && $temp["outside_24h_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$temp["outside_24h_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//temp min yesterday
	if ($temp["outside_24h_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$temp["outside_24h_min"] . "</value>";}
...
<div class="temperaturetrend"><span style='color:rgba(68, 166, 181, 1.000)'><b>Temp Min</b></span><br><?php echo $temp["outside_24h_mintime"];?></span></div>
   ...
   <div class="temperaturecontainer1">
			  ...
			  <?php
	////dew max yesterday
	if ($tempunit=='C' && $dew["24h_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$dew["24h_max"] . "</value>";}
	echo "<smalluvunit>˚".$temp["units"]."</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	//dew min yesterday
	if ($dew["24h_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$dew["24h_min"] . "</value>";}
...
<div class="temperaturecontainer1">
	...
	if ($humid["24h_max"]>=-50)  {
	echo "<div class='temperaturetoday24'>",$humid["24h_max"] . "</value>";}
	echo "<smalluvunit>%</smalluvunit>"
	?> </div>
...
<div class="temperaturecontainer2">
 <?php
	...
	if ($humid["24h_min"]>=-50)  {
	echo "<div class='temperaturetoday0'>",$humid["24h_min"] . "</value>";}
