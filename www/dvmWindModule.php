...
<head>
<meta charset="utf-8">
<title>wind compass for weewx</title>
</head>
...
function Currently(x, y, displayText) {
    ...
    currently.setAttributeNS(null, "fill", baseTextColor);
...
function Gust(x, y, displayText) {
    ...
    gust.setAttributeNS(null, "fill", baseTextColor);
...
function unitsLeft(x, y, displayText) {
    ...
    unitsleft.setAttributeNS(null, "fill", baseTextColor);
...
function unitsRight(x, y, displayText) {
    ...
    unitsright.setAttributeNS(null, "fill", baseTextColor);
