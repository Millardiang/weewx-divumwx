...
<head>
    ...
    <script src="dvmhighcharts/newScripts/jquery.min.js"></script>
    <script src="dvmhighcharts/newScripts/highstock.js"></script>
    <script src="dvmhighcharts/newScripts/annotations.js"></script>
    <script src="dvmhighcharts/newScripts/boost.js"></script>
    <script src="dvmhighcharts/newScripts/highcharts-more.js"></script>
    <script src="dvmhighcharts/newScripts/exporting.js"></script>
    <script src="dvmhighcharts/newScripts/export-data.js"></script>
    <script src="dvmhighcharts/newScripts/Divumwx-<?php echo $theme;?>.js" type="text/javascript"></script>
</head>
<body>
