...
if ($rainunit != $rain["units"])
{
    if ($rainunit == "mm")
    {
        ...
        inTomm($rain, "p_24h_total");
        inTomm($rain, "day");
        inTomm($rain, "yesterday");
        inTomm($rain, "month_total");
        inTomm($rain, "year_total");
        inTomm($rain, "alltime_total");
        inTomm($rain, "p_current");
        inTomm($rain, "p_rate");
        inTomm($rain, "p_total");
        inTomm($rain, "p_last_10min");
        inTomm($rain, "p_last_hour");
        inTomm($rain, "p_24h_total");
        inTomm($rain, "p_last_24hour");
        inTomm($rain, "p_day");
        inTomm($rain, "p_day_total");
        inTomm($rain, "p_yesterday");
        inTomm($rain, "p_month_total");
        inTomm($rain, "p_year_total");
        inTomm($rain, "p_alltime_total");
        inTomm($rain, "p_last_rain");
        inTomm($rain, "p_storm_rain");
        inTomm($rain, "et_current");
        inTomm($rain, "et_hour");
        inTomm($rain, "et_day");
        inTomm($rain, "et_24hr");
        inTomm($rain, "et_week");
        inTomm($rain, "et_month");
        inTomm($rain, "et_year");
        inTomm($rain, "et_alltime");
        $rain["units"] = $rainunit;
    }
    else if ($rainunit == "in")
    {
        ...
        mmToin($rain, "p_24h_total");
        mmToin($rain, "day");
        mmToin($rain, "yesterday");
        mmToin($rain, "month_total");
        mmToin($rain, "year_total");
        mmToin($rain, "alltime_total");
        mmToin($rain, "p_current");
        mmToin($rain, "p_rate");
        mmToin($rain, "p_total");
        mmToin($rain, "p_last_10min");
        mmToin($rain, "p_last_hour");
        mmToin($rain, "p_24h_total");
        mmToin($rain, "p_last_24hour");
        mmToin($rain, "p_day");
        mmToin($rain, "p_day_total");
        mmToin($rain, "p_yesterday");
        mmToin($rain, "p_month_total");
        mmToin($rain, "p_year_total");
        mmToin($rain, "p_alltime_total");
        mmToin($rain, "p_last_rain");
        mmToin($rain, "p_storm_rain");
        mmToin($rain, "et_current");
        mmToin($rain, "et_current");
        mmToin($rain, "et_hour");
        mmToin($rain, "et_day");
        mmToin($rain, "et_24hr");
        mmToin($rain, "et_week");
        mmToin($rain, "et_month");
        mmToin($rain, "et_year");
        mmToin($rain, "et_alltime");     
        $rain["units"] = $rainunit;
    }
}
