...
<head>
  <meta charset="UTF-8">
  <title>DivumWX-Lite Testing</title>
  <style>
  #csv {
    display: none;
}
...
;?>
    <meta charset="UTF-8">
    <title>DivumWX-Lite Testing Current Weather Conditions</title>
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'DivumWX-Lite Testing',
        y: 5
    },

    subtitle: {
        text: 'Temperature variation by day and hour through 2024',
        y: 20
    },
    ...
    xAxis: {
        ...
        max: Date.UTC(2024, 11, 31, 23, 59, 59),
        labels: {
            y: 18,
            format: '{value:%b}'
        },
