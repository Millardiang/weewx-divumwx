...
<?php
//pressure max today
if ($barom["max"] >= 0) { echo "<div class='temperaturetoday24'>",$barom["max"] . "</value>";} echo "<smalluvunit>" . $barom["units"] . "</smalluvunit>";?></div>
...
<?php
//pressure min today
if ($barom["min"] >= 0) { echo "<div class='temperaturetoday0'>",$barom["min"] . "</value>";} echo "<smalluvunit>" . $barom["units"] . "</smalluvunit>";?></div>
...
if ($barom["yesterday_max"] >= 0) { echo "<div class='temperaturetoday24'>",$barom["yesterday_max"] . "</value>";} echo "<smalluvunit>" . $barom["units"] . "</smalluvunit>";?></div>
...
if ($barom["yesterday_min"] >= 0) { echo "<div class='temperaturetoday0'>",$barom["yesterday_min"] . "</value>";} echo "<smalluvunit>" . $barom["units"] . "</smalluvunit>";?></div>
...
<?php
//pressure max month
if ($barom["month_max"] >= 0) { echo "<div class='temperaturetoday24'>",$barom["month_max"] . "</value>";} echo "<smalluvunit>" . $barom["units"] . "</smalluvunit>";?></div>
...
<?php
//pressure min month
if ($barom["month_min"] >= 0) { echo "<div class='temperaturetoday0'>",$barom["month_min"] . "</value>";} echo "<smalluvunit>" . $barom["units"] . "</smalluvunit>";?></div>
...
<?php
//pressure max year
if ($barom["year_max"] >= 0) { echo "<div class='temperaturetoday24'>",$barom["year_max"] . "</value>";} echo "<smalluvunit>" . $barom["units"] . "</smalluvunit>";?></div>
...
<?php
//pressure min year
if ($barom["year_min"] >= 0) { echo "<div class='temperaturetoday0'>",$barom["year_min"] . "</value>";} echo "<smalluvunit>" . $barom["units"] . "</smalluvunit>";?></div>
...
if ($barom["alltime_max"] >= 0) { echo "<div class='temperaturetoday24'>",$barom["alltime_max"] . "</value>";} echo "<smalluvunit>" . $barom["units"] . "</smalluvunit>";?></div>
...
if ($barom["alltime_min"] >= 0) { echo "<div class='temperaturetoday0'>",$barom["alltime_min"] . "</value>";} echo "<smalluvunit>" . $barom["units"] . "</smalluvunit>";?></div>
...
<main class="grid1">
<articlegraph> 
<iframe  src="w34highcharts/<?php echo $theme1;?>-charts.html?chart='barsmallplot'&span='yearly'&temp='<?php echo $temp["units"];?>'&pressure='<?php echo $barom["units"];?>'&wind='<?php echo $wind["units"];?>'&rain='<?php echo $rain["units"];?>" frameborder="0" scrolling="no" width="100%" height="100%"></iframe>
...
<div class="lotemp">
<?php echo $info;?> Adapted by Steepleian for the WeeWX Weather34 skin from the original CSS/SVG/PHP scripts by weather34.com &copy; 2015-<?php echo date("Y");?></a></div>
</articlegraph>   
</main></main>
