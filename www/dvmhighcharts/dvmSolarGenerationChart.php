...
$generation = $parsed_json[0]["solarGenerationplot"]["series"]["wattsWeek"];
$generationWeek = json_encode($generation);
...
<script>
var generationWeek = <?php echo $generationWeek;?>;
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Solar Electric Generation 7 Day Chart',
        align: 'center'
    },
    chart: {
        height: 500,
