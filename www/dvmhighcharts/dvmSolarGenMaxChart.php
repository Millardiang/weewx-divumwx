...
$solarGenDecode = $parsed_json[0]['solarGenMaxPlot']['series']['watts']['name'];
...
Highcharts.chart('solarGen-chart', {
    ...
    title: {
        text: 'Daily Maximum Solar Electrical Power Generation'
    },
    tooltip: { 
        valueDecimals: 0,
    ...
    series: [{
        ...
        name: 'Maximum Electrical Power Generation',
        type: 'column',
        data: solarGen,
        tooltip: { 
            valueSuffix: ' ' + units 
