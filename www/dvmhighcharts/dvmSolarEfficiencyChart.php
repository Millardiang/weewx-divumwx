...
$dataDecodeOne = $parsed_json[0]["powerPlot"]["series"]["dailySolarEfficiencyMax"];
$dataOne = json_encode($dataDecodeOne);
$dataDecodeTwo = $parsed_json[0]["powerPlot"]["series"]["dailySolarEfficiencyAvg"];
...
Highcharts.chart('power-chart', {
    ...
    title: {
        text: 'Photo Voltaic Panel Efficiency (%)'
    },
    tooltip: { 
        valueDecimals: 0,
        style: {
    ...
    series: [{
        name: 'Solar Efficiency Maximum',
        type: 'spline',
        data: <?php echo $dataOne;?>
    }, {
        name: 'Solar Efficiency Average',
        type: 'spline',
