...
$gridProdDecode = $parsed_json[0]["gridProductionMaxPlot"]["series"]["watts"]["name"];
$gridProd = json_encode($gridProdDecode);
$solarBatteryDecode = $parsed_json[0]["solarBatteryMaxPlot"]["series"]["watts"]["name"];
$solarBattery = json_encode($solarBatteryDecode);
$solarPanelDecode = $parsed_json[0]["solarPanelMaxPlot"]["series"]["watts"]["name"];
$solarPanel = json_encode($solarPanelDecode);
?>
...
<script>
var units = "W";
var gridProd = <?php echo $gridProd;?>;
var solarBattery = <?php echo $solarBattery;?>;
var solarPanel = <?php echo $solarPanel;?>;
...
Highcharts.chart('power-chart', {
    ...
    series: [{
        name: 'Peak Grid Power Usage',
        type: 'column',
        data: gridProd
    }, {
        name: 'Peak Battery Power Usage',
        type: 'column',
        data: solarBattery
    }, {
        name: 'Peak Solar Power Usage',
        type: 'column',
        data: solarPanel
