...
$sunduration = $parsed_json[0]["solarplot"]["series"]["sunshine_time_5min"]["name"];
$threshold = $parsed_json[0]["solarplot"]["series"]["threshold"]["name"]; 
$radiation = $parsed_json[0]["solarplot"]["series"]["radiation"]["name"];
$sundurationWeek = json_encode($sunduration);
$thresholdWeek = json_encode($threshold); 
$radiationWeek = json_encode($radiation);
...
var thresholdWeek = <?php echo $thresholdWeek;?>;
var radiationWeek = <?php echo $radiationWeek;?>;
...
Highcharts.chart('week-chart', {
    ...
    series: [{
        name: 'Sunlight Duration (min)',
        type: 'column',
        data: sundurationWeek
    },  {
        name: 'Sunlight Threshold (W/m\xB2)',
        type: 'spline',
        data: thresholdWeek,
        yAxis: 1
    },  {
        name: 'Solar Radiation (W/m\xB2)',
        type: 'spline',
        data: radiationWeek,
        yAxis: 1
    }],
