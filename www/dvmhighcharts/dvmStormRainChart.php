...
if($rainunit == "in"){$stormRainLast = $parsed_json[0]["stormRainplot"]["series"]["storm_rain_inch"]; $unit = "inches";}
else {$stormRainLast = $parsed_json[0]["stormRainplot"]["series"]["storm_rain_mm"]; $unit = "mm";}
$stormRain = json_encode($stormRainLast);
if ($theme === "dark") {
...
<div id="stormRain-chart"></div>



<script>
var units = "<?php echo $unit;?>";
var stormRain = <?php echo $stormRain;?>;
...
Highcharts.chart('stormRain-chart', {
    time: {
