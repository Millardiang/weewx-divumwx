...
$alder = $parsed_json[0]["pollenplot"]["series"]["alder_pollen"];
$birch = $parsed_json[0]["pollenplot"]["series"]["birch_pollen"]; 
$olive = $parsed_json[0]["pollenplot"]["series"]["olive_pollen"];
$grass = $parsed_json[0]["pollenplot"]["series"]["grass_pollen"];
$mugwort = $parsed_json[0]["pollenplot"]["series"]["mugwort_pollen"];
$ragweed = $parsed_json[0]["pollenplot"]["series"]["ragweed_pollen"];
$alderYear = json_encode($alder);
$birchYear = json_encode($birch); 
$oliveYear = json_encode($olive);
$grassYear = json_encode($grass);
$mugwortYear = json_encode($mugwort);
$ragweedYear = json_encode($ragweed);
...
<script>
var alderYear = <?php echo $alderYear;?>;
var birchYear = <?php echo $birchYear;?>;
var oliveYear = <?php echo $oliveYear;?>;
var grassYear = <?php echo $grassYear;?>;
var mugwortYear = <?php echo $mugwortYear;?>;
var ragweedYear = <?php echo $ragweedYear;?>;
