...
$solGen = $parsed_json[0]["solarGenerationplot"]["series"]["wattsYesterday"][1];
$solGenE = json_encode($solGen);
...
<figure class="highcharts-figure">
  ...
  <script>
const data = <?php echo $solGenE;?>;

Highcharts.chart('container', {

    title: {
        text: 'Solar Power Generation - Yesterday'
    },
    exporting: { 
        enabled: false 
    },  
    ...
    xAxis: [{
        title: {
            text: 'Observations at 5minute intervals'
        },
        alignTicks: false
    }, {
        title: {
