...
$gridImportDecode = $parsed_json[0]["gridImportPlot"];
$gridImport = json_encode($gridImportDecode);
$gridExportDecode = $parsed_json[0]["gridExportPlot"];
$gridExport = json_encode($gridExportDecode);
$batteryDischargeDecode = $parsed_json[0]["batteryDischargePlot"];
$batteryDischarge = json_encode($batteryDischargeDecode);
$batteryChargeDecode = $parsed_json[0]["batteryChargePlot"];
$batteryCharge = json_encode($batteryChargeDecode);
$solarPanelImportDecode = $parsed_json[0]["solarPanelImportPlot"];
$solarPanelImport = json_encode($solarPanelImportDecode);
?>
...
<head>
    ...
    <script src="scripts/divum-<?php echo $theme;?>.js" type="text/javascript"></script>
...
<script>
var units = "W";
var gridImport = <?php echo $gridImport;?>;
var gridExport = <?php echo $gridExport;?>;
var batteryDischarge = <?php echo $batteryDischarge;?>;
var batteryCharge = <?php echo $batteryCharge;?>;
var solarPanelImport = <?php echo $solarPanelImport;?>;
...
Highcharts.chart('power-chart', {
    ...
    series: [{
        name: 'Peak Grid Power Import',
        type: 'spline',
        data: gridImport
    }, {
        name: 'Peak Power Export to Grid',
        type: 'spline',
        data: gridExport
    }, {
        name: 'Peak Battery Power Discharge',
        type: 'spline',
        data: batteryDischarge
    }, {
        name: 'Peak Battery Power Charge',
        type: 'spline',
        data: batteryCharge
    }, {
        name: 'Peak Solar Power Import',
        type: 'spline',
        data: solarPanelImport
