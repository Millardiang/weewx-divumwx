...
$pm2_5 = $parsed_json[0]["airqualityplot"]["series"]["pm2_5"];
$pm10 = $parsed_json[0]["airqualityplot"]["series"]["pm10_0"]; 
$co = $parsed_json[0]["airqualityplot"]["series"]["co"];
$no2 = $parsed_json[0]["airqualityplot"]["series"]["no2"];
$so2 = $parsed_json[0]["airqualityplot"]["series"]["so2"];
$o3 = $parsed_json[0]["airqualityplot"]["series"]["o3"];
$nh3 = $parsed_json[0]["airqualityplot"]["series"]["nh3"];
