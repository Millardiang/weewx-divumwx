...
$alderWeek = json_encode($parsed_json[0]["powerPlot"]["series"]["dailyBatteryCharge"]);
$birchWeek = json_encode($parsed_json[0]["powerPlot"]["series"]["dailyBatteryDischarge"]); 
$oliveWeek = json_encode($parsed_json[0]["powerPlot"]["series"]["dailyGridExport"]);
$grassWeek = json_encode($parsed_json[0]["powerPlot"]["series"]["dailyGridImport"]);
$mugwortWeek = json_encode($parsed_json[0]["powerPlot"]["series"]["dailyLoadEnergy"]);
$ragweedWeek = json_encode($parsed_json[0]["powerPlot"]["series"]["dailySolarEnergy"]);
include('../fixedSettings.php');
//include('powSelect.php');
if ($theme === "dark") {
