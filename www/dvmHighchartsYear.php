...
-->
  ...
  <head>
    ...
    <script src="dvmhighcharts/scripts/<?php echo $theme;?>-theme.js" type="text/javascript"></script>
    <script src="dvmhighcharts/scripts/extraPlots.js" type="text/javascript"></script>
