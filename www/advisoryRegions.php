...
switch ($advisoryzoneMapping) {
    ...
    include('advisoryAurora.php');
        ...
        if ($cnt + $fCnt == 1) {
            $aHeader = "The following alert is currently in force potentially affecting the ";
        } else {
            $aHeader = "The following alerts are currently in force potentially affecting the ";
        }
        echo '<div id="alert">';
        if ($cnt + $fCnt == 0) {
            $aPhrase = "There are currently no weather advisories, alerts or warnings in force potentially affecting the " . $stationlocation . " area.";
            echo '<div class="alertbar" style="margin-top:4px;"><bold>' . $aPhrase . '</bold></div>';
        } else {
      ...
      <?php }
        ...
        for ($i = 0; $i < $fCnt; $i++) {
            ...
            $floodHeadline[$i] = "  " . $floodAlertlevel[$i] . " for " . $floodDescription[$i] . ".  ";
      ...
      <div class="alert-text-box" style="padding-left:20px;padding-right:20px;display:flex;margin: 0 auto;">
    <div class="post" style="font-weight:500;font-size:14px;color:<?php echo $floodAlertColor[$i]; ?>;"><img src="css/svg/icon-warning-flood-<?php echo $floodBackground[$i]; ?>.svg"style="margin-bottom:-10px;">
            <?php echo $floodHeadline[$i]; ?><img src="css/svg/icon-warning-flood-<?php echo $floodBackground[$i]; ?>.svg"style="margin-bottom:-10px;">
