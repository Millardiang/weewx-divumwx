...
<head>
<meta charset="UTF-8">
<title>Lightning Records Information</title>
...
<article>
    ...
    <?php echo "<div class='rainfalltoday1'>",$lightning["yesterday_strike_count"]. "</value>"?></div>
</article>
...
<article>
    ...
    <?php echo "<div class='rainfalltoday1'>",$lightning["alltime_strike_count"]. "</value>"?></div>
</article>   
</main>
<main class="grid1">
