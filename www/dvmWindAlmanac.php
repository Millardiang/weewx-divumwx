...
<head>
  <meta charset="UTF-8">
  <title>divumwx Windgust Almanac Information</title>
...
<?php //convert rain
if($wind["units"] =='km/h'){echo number_format($wind["gust_max"]*3.6,1)." <smalluvunit>mph</smalluvunit";}
if($wind["units"] =='mph'){ echo number_format($wind["gust_max"]*2.23694,1)."<smalluvunit>km/h</smalluvunit>";}
if($wind["units"] =='m/s'){ echo number_format($wind["gust_max"]*1,1)."<smalluvunit>km/h</smalluvunit>";}
if($wind["units"] =='kts'){ echo number_format($wind["gust_max"]*1.94384,1)."<smalluvunit>km/h</smalluvunit>";}
?>
</div>
...
<div class='dvmconvertrain'>
<?php //convert rain
if($wind["units"] =='km/h'){echo number_format($wind["gust_yesterday_max"]*3.6,1)." <smalluvunit>mph</smalluvunit";}
if($wind["units"] =='mph'){ echo number_format($wind["gust_yesterday_max"]*2.23694,1)."<smalluvunit>km/h</smalluvunit>";}
if($wind["units"] =='m/s'){ echo number_format($wind["gust_yesterday_max"]*1,1)."<smalluvunit>km/h</smalluvunit>";}
if($wind["units"] =='kts'){ echo number_format($wind["gust_yesterday_max"]*1.94384,1)."<smalluvunit>km/h</smalluvunit>";}
?>
</div>
...
<div class='dvmconvertrain'>
<?php //convert rain
if($wind["units"] =='km/h'){echo number_format($wind["gust_month_max"]*3.6,1)." <smalluvunit>mph</smalluvunit";}
if($wind["units"] =='mph'){ echo number_format($wind["gust_month_max"]*2.23694,1)."<smalluvunit>km/h</smalluvunit>";}
if($wind["units"] =='m/s'){ echo number_format($wind["gust_month_max"]*1,1)."<smalluvunit>km/h</smalluvunit>";}
if($wind["units"] =='kts'){ echo number_format($wind["gust_month_max"]*1.94384,1)."<smalluvunit>km/h</smalluvunit>";}
?>
</div>
...
if($wind["units"] =='km/h'){echo number_format($wind["gust_year_max"]*3.6,1)." <smalluvunit>mph</smalluvunit";}
if($wind["units"] =='mph'){ echo number_format($wind["gust_year_max"]*2.23694,1)."<smalluvunit>km/h</smalluvunit>";}
if($wind["units"] =='m/s'){ echo number_format($wind["gust_year_max"]*1,1)."<smalluvunit>km/h</smalluvunit>";}
if($wind["units"] =='kts'){ echo number_format($wind["gust_year_max"]*1.94384,1)."<smalluvunit>km/h</smalluvunit>";}
?>
</div>
...
<div class='dvmconvertrain'>
<?php //convert rain
if($wind["units"] =='km/h'){echo number_format($wind["gust_alltime_max"]*3.6,1)." <smalluvunit>mph</smalluvunit";}
if($wind["units"] =='mph'){ echo number_format($wind["gust_alltime_max"]*2.23694,1)."<smalluvunit>km/h</smalluvunit>";}
if($wind["units"] =='m/s'){ echo number_format($wind["gust_alltime_max"]*1,1)."<smalluvunit>km/h</smalluvunit>";}
if($wind["units"] =='kts'){ echo number_format($wind["gust_alltime_max"]*1.94384,1)."<smalluvunit>km/h</smalluvunit>";}
?>
</div>
