...
if ($wind["units"]=="km/h"{$wind["speed_bft"] = $wind["speed"]*1.1268 ;}
else if ($wind["units"]=="m/s"){$wind["speed_bft"] = $wind["speed"]*0.4797;}  
else if ($wind["units"]=="mph"){$wind["speed_bft"] = $wind["speed"]*0.658 8 ;} 
...
else if ($wind["units"]=="mph" && $wind["gust"]*$toKnots>=16.1987){echo "<div class=windconvertercircleblue1>".number_format($wind["gust"]*1.609343502101025,1)." <smallrainunit>&nbsp;kmh</smallrainunit>";}
else if ($wind["units"]=="mph" && $wind["gust"]*$toKnots<16.1987){echo "<div class=windconvertercirclegreen1><tgreen>".number_format($wind["gust"]*1.609343502101025,1)." </tgreen><smallrainunit>&nbsp;kmh</smallrainunit>";}
...
else if ($wind["units"]=="m/s" && $wind["gust"]*$toKnots>=16.1987){echo "<div class=windconvertercircleblue1>".number_format($wind["gust"]*3.60000288,1)." <smallrainunit>&nbsp;kmh</smallrainunit>";}
else if ($wind["units"]=="m/s" && $wind["gust"]*$toKnots<16.1987){echo "<div class=windconvertercirclegreen1><tgreen>".number_format($wind["gust"]*3.60000288,1)." </tgreen><smallrainunit>&nbsp;kmh</smallrainunit>";}?>
</div></div>
<?php 
