...
<head>
    <meta charset="UTF-8">
    <title>divumwx Strikes Almanac Information</title>
...
<article>
    ...
    <?php echo "<div class='lightning'>",$lightning["yesterday_strike_count"]. "</value>"?></div>
</article>

<article>
    <div class=actualt>Strikes <?php echo date('M Y');?> </div>
    <?php echo "<div class='lightning'>",$lightning["month_strike_count"]. "</value>"?></div>
</article>

<article>
     <div class=actualt>Strikes <?php echo date("Y");?> </div>
    <?php echo "<div class='lightning'>",$lightning["year_strike_count"]. "</value>"?></div>
</article>
...
<a href="https://highcharts.com" title="https://highcharts.com" target="_blank" style="font-size:8px; height: 100%;"> Charts rendered and compiled using Highcharts </a></span>
  ...
  <div class="lotemp">
  <?php echo $info?> Adapted by Jerry for the WeeWX divumwx template from the original CSS/SVG/PHP scripts by divumwx.com &copy; 2015-<?php echo date('Y');?>
  </a></div>
