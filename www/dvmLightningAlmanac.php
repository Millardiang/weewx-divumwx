...
<head>
    <meta charset="UTF-8">
    <title>Lightning Strikes Almanac Information</title>
...
<iframe width="100%" height="100%" scrolling="no" src="dvmhighcharts/dvmLightningChartYear.php" frameborder="0"></iframe>
</articlegraph>
