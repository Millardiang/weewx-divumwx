...
<div class="divumwxdarkbrowser" url="Sunlight Duration"></div>


 <main class="grid1">
        <articlegraph style="height:250px">
<iframe width="100%" height="100%" scrolling="no" src="dvmhighcharts/dvmSunlightDurationChart.php" frameborder="0"></iframe>
