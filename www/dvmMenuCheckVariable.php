...
<button class="tablink" onclick="openPage('Tab2', this, 'rgba(194, 102, 58)')">Combined Data Template Generated</button>
  ...
  <iframe width="100%" height="92%" scrolling="yes" src="dvmCheckLive.php" frameborder="0"></iframe>
</div>
  
  <div id="Tab2" class="tabcontent">
  
  <iframe width="100%" height="92%" scrolling="yes" src="dvmCheckArchive.php" frameborder="0"></iframe>
</div>
