...
<div class="divumfooter-container">
    <div class="divumfooter-item">
      ...
      <div class="footertext" style="font-size: 10px;"><?php echo "Operational Since " . date("j M Y",$divum["since"])." - "; $info;?> (<value><?php echo $templateversion;?></value>) <?php echo " - WeeWX[MM]";?>-(<value><maxred><?php echo $divum["swversion"];?></value>)  - OS- <yellow><?php echo " " . $weatherhardware . "". $os_version." - PHP " . substr($phpVersion,0,7);?></value></div>
