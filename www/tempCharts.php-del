...
<html>
  <head>
    ...
    <script src="dvmhighcharts/scripts/jquery-1.12.4.min.js"></script>
    <script src="dvmhighcharts/scripts/jquerry-ui-1.12.1.min.js"></script>
    <script src="dvmhighcharts/scripts/highstock.js"></script>
    <script src="dvmhighcharts/scripts/highcharts-more.js"></script>
    <script src="dvmhighcharts/scripts/windbarb.js"></script>
    ...
    <script src="dvmhighcharts/scripts/plots_config.js" type="text/javascript"></script>
    <script src="dvmhighcharts/scripts/plots.js" type="text/javascript"></script>
    <script src="dvmhighcharts/scripts/convert_units.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        window.onload = function() {
            ...
            if(vars['chart'] != 'windroseplot'){
                ...
                $("#plot_div1").css("height", 520);
                $("#plot_div2").css("height", 520);
