...
if ($divum["wind_units"] == 'mph') {$depth[$j] =  "Depth ".round($parsed_json['features'][$j]['properties']['depth'] * 0.621371)."mi";}  
...
<head>
  <meta charset="UTF-8">
  <title>Recent UK Earthquakes Information</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  
<div class="divumwxdarkbrowser" url="Recent Earthquakes" scrolling="no"></div>  
<main class="grid">
<?php
for ($j = 0;$j < 50;$j++)
{
