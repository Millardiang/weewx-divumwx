<?php //original weather34 script original css/svg/php by weather34 2015-2019 // 
 include_once('w34CombinedData.php');include_once('userfixedSettings.php');include_once('common.php');include_once('webserver_ip_address.php');date_default_timezone_set($TZ);
?>
