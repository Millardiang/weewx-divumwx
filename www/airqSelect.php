...
<div id="title_bar" style="margin-top: 10px; margin-left 14px; margin-bottom: 7px;">
  <div id="reports">
    <select name="reports" onchange="openAirQualityCharts(value)"  style="background-color: rgb(194,102,58); color: white; border: 2px solid rgb(194,102,58); border-radius: 5px;">
      <option value="dvmhighcharts/dvmAirQualityWeekChart.php">Air Quality Weekly</option>
      <option value="dvmhighcharts/dvmAirQualityYearChart.php">Air Quality Yearly</option>
